...
public class Persona {
    ...
    boolean eliminado; // Cuando no ponemos ningun modificador de acceso como aca, la variable se puede acceder desde 
    // todo el paquete. Es decir, todas las clases del mismo paquete pueden acceder a esta propiedad. Se llama default.
