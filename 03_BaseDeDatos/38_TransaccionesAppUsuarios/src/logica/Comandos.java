...
public class Comandos {
    ...
    public Comandos(Connection conexionTransaccional) {
    ...
    public void seleccionar() throws SQLException {
        ...
        try {
            conn = this.conexionTransaccional != null ? this.conexionTransaccional : Conexion.obtenerConexion();
    ...
    public void insertar(Usuario usuario) {
        ...
        try {
            ...
            if (userList.isEmpty()) { // Devuelve true si la lista esta vacia
